...
class InferenceHandler(BaseHTTPRequestHandler):
    ...
    def _handle_inference(self):
        ...
        try:
            ...
            # Try to use orchestrator first if it has registered agents
            ...
            if (hasattr(self, 'orchestrator') and self.orchestrator and 
                ...
                try:
                    ...
                    logger.info("Falling back to standalone agent")
                    # Fall through to standalone agent as backup
            
            # Return status response when orchestrator is not available or failed
            response = {
                "input": {
